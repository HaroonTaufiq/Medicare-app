        ...
        <div className='grid  md:grid-cols-3 gap-[50px]'>
          <div className='md:col-span-2'>
            ...
            font-semibold rounded'>
              ...
              <p className='text-18 leading-30 font-400 text-textColor mt-18 text-14px leading-5 md:text-[15px]
              lg:max-w-[390px]'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi, dolor.</p>
            </div>
            </div>

            <div className='mt-[50] border-b border-solid border-[#0066ff34]'>
