...
const Home = () => {
  return (
        ...
        <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
          ...
          <div>
            <div className='lg:w-[570px]'>
              ...
              md:leading-[70px]'>
                We help patients have a healty, longer life
              </h1>
              <p className='text-18 leading-30 font-400 text-textColor mt-18'>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
                Quidem natus tempore cumque soluta fugit suscipit provident nobis, 
                fugiat necessitatibus est temporibus modi eligendi nihil voluptatum, 
                tempora asperiores autem nam ex.
              </p>
              <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full'>Request an Appointment</button>
            </div>
            ...
            <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]'>
              <div>
                ...
                <p className='text-18 leading-30 font-400 text-textColor mt-18'>Years Of Expierence</p>
              </div>

              <div>
                <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg-leading-[54px] font-[700] text-headingColor'>15+</h2>
                <span className='w-[100px] h-2 bg-purpleColor rounded-full block mt-[-14px]'></span>
                <p className='text-18 leading-30 font-400 text-textColor mt-18'>Clinic Location</p>
              </div>

              <div>
                <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg-leading-[54px] font-[700] text-headingColor'>100%</h2>
                <span className='w-[100px] h-2 bg-irisBlueColor rounded-full block mt-[-14px]'></span>
                <p className='text-18 leading-30 font-400 text-textColor mt-18'>Patients Statisfaction</p>
              </div>
            </div>
          </div>
         {/* ==========hero content======== */}
    ...
    <section>
      <div className='container'>
        <div className='lg:w-[470px] mx-auto'>
          ...
          <p className='text-18 leading-30 font-400 text-textColor mt-18 text-center'>
    ...
    <section>
      <div className='conatiner lg:w-[1214px] mx-auto'>
        <div className='lg:w-[470px] mx-auto'>
          <h2 className='heading text-center mt-[30px]'>Our Medical Services</h2>
...
<ServiceList/>
      ...
      <div className='container lg:w-[1280px] mx-auto'>
        <div className='flex items-center justify-between flex-col lg:flex-row'>
          ...
          <div className='lg:w-[470px] mx-auto'>
            ...
            <ul className='pl-4'>
              <li className='text-18 font-400 text-textColor mt-[30]'>
               1. Schedule the appointment directly </li>
               <li className='text-18 font-400 text-textColor mt-[30]'>
               2. Search for your physician here, and contact thier office </li>
               <li className='text-18 font-400 text-textColor mt-[30]'>
               3. View our physicians who are accepting new patients, use the online
               scheduling tool to select the an appointment time </li>
            </ul>
            <Link to='/'>
          ...
          <div className='relative z-10 xl-w-[770px] flex justify-end mt-[50px] lg:mt-0'>
            ...
            <div className='w-[150] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2
            pb-3 lg:px-4 lg:pb-[26px] rounded-[10px]'>
              ...
              <div className='w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px]
    ...
    <section>
      <div className="container">
      <div className='lg:w-[470px] mx-auto'>
          <h2 className='heading text-center mt-[30px]'>Our Great Doctors</h2>
          <p className='text-18 leading-30 font-400 text-textColor mt-[30px] text-center'>
            World Class care for everyone. Our health system offers unmtched,
            expert health care.
          </p>
