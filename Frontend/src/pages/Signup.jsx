        ...
        <div className='max-w-[1170px] mx-auto'>
          ...
          placeholder:text-textColor rounded-md cursor-pointer'
            ...
            leading-6 overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer'>
                ...
                <div className='mt-7'>
                  <button disabled={loading && true} type='submit' className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full
                        w-full bg-primaryColor text-White text-[18px] leading-[30px] rounded-lg'>{loading ? (<HashLoader size ={35} color='#ffffff'/> ):( "Sign Up")}</button>
                </div>
